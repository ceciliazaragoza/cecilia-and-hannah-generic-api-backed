                ...
                {data.collection.items.map((item, index) => (
                    <div key={index} className="card">
                        <div className="card-container">
                            ...
                            <div><img className="nasa-image" src={item.links[0].href} alt={item.data[0].description}/></div>
                            {item.data[0].description !== item.data[0].title && (<div>{item.data[0].description}</div>) }
                        </div>
                    </div>
                ))}
            </div>
